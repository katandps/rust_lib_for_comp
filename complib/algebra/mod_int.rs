...
pub mod const_mod_factorial;
pub mod embedded_mod_factorial;
pub mod mod_factorial;
pub mod mod_int_64bit;
...
#[codesnip::entry("mod-int", include("prelude", "algebra"))]
...
#[codesnip::entry("pow-table", include("faster-hashmap", "mod-int", "algebra"))]
#[derive(Clone, Debug, Default)]
/// # 2のべき乗を都度生成するDefaultDict
pub struct PowTable<const M: u32>(HashMap<i64, ModInt<M>>);
#[codesnip::entry("pow-table", include("faster-hashmap", "mod-int", "algebra"))]
impl<const M: u32> PowTable<M> {
    pub fn pow(&mut self, e: i64) -> ModInt<M> {
        *self
            .0
            .entry(e)
            .or_insert_with(|| ModInt::<M>::new(2).pow(e))
    }
}
