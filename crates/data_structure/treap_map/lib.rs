...
pub use treap_impl::Treap;
mod treap_impl {

    use super::{swap, Debug, Display, Formatter, Ordering, XorShift};
    ...
    impl<K: Clone + PartialOrd + Default + Debug, V: Clone + Default> From<&[(K, V)]> for Treap<K, V> {
